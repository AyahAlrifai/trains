...
function computer_play()
{
  ...
  if(count%2==0)
  {
  stone.style.left=parseInt(actionto.style.left)+"%";
  stone.style.top=parseInt(actionto.style.top)+"%";
...
{
x.style.left=parseInt(event.target.style.left)+"%";
